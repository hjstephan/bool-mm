...
Für \textbf{Boolean Matrizen} jedoch, bei denen alle Einträge $\in \{0, 1\}$ sind und die Operationen durch logische Operationen ersetzt werden, können wir die Signatur-Technik aus dem Subgraph Algorithmus nutzen, um eine Laufzeit von $O(n^2)$ zu erreichen.
...
\section{Grundlagen aus dem Subgraph Algorithmus}
...
\subsection{Eigenschaften der Signatur}
...
\begin{proof}
	Die bitweise UND-Operation auf Dezimalzahlen entspricht genau der komponentenweisen UND-Operation auf den Binärdarstellungen. Da die Signatur die Binärdarstellung ist, folgt die Behauptung direkt.
\end{proof}
...
Algorithmus \ref{alg:bmm} beschreibt die Arbeitsweise des zur Boolean Matrixmultiplikation mit Signaturen.
